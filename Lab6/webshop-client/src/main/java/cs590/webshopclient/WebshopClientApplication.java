package cs590.webshopclient;

import cs590.webshopclient.service.*;
...
public class WebshopClientApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        restTemplate.postForObject("http://localhost:8081/customer", customerDto, CustomerDTO.class);

        // get customer
        //todo: call the customer component to get the customer with id 101 and print the result
        CustomerDTO customerDTO= restTemplate.getForObject("http://localhost:8081/customer/101", CustomerDTO.class);
        System.out.println(customerDTO);
        System.out.println("\n-------------------------------------------------------------------------------------");

        //create products
        String createProductUrl = "http://localhost:8082/product/{productnumber}/{description}/{price}";
        ...
        //set stock
        String setStockUrl = "http://localhost:8082/product/stock/{productnumber}/{quantity}/{locationcode}";
        //Stock 1
        ...
        String getProductUrl = "http://localhost:8082/product/{productnumber}";
        ...
        String addToCartUrl = "http://localhost:8083/cart/{cartId}/{productnumber}/{quantity}";
        ...
        String getCartUrl = "http://localhost:8083/cart/{cartId}";
        ...
        //checkout the cart
        String checkoutCartUrl = "http://localhost:8083/cart/checkout/{cartId}";
        ...
        //get the order
        String getOrderUrl = "http://localhost:8084/order/{orderNumber}";
        ...
        String addCustomerToOrderUrl = "http://localhost:8084/order/setCustomer/{orderNumber}/{customerNumber}";
        ...
        //confirm the order
        String confirmOrderUrl = "http://localhost:8084/order/{orderNumber}";
